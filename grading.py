  ...
  def produceGradeScopeOutput(self):
    ...
    for name in self.questions:
      ...
      test_out['output'] = "  Question {num} ({points}/{max}) {correct}".format(
          ...
          correct=('Some points were missed for this question. Please run the autograder on your machine and read the output. Ask for clarification if needed.' if not is_correct else ''),
      )
      test_out['tags'] = []
